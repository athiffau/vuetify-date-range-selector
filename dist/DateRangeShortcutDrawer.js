...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('v-navigation-drawer',{attrs:{"absolute":"","temporary":""},model:{value:(_vm.isOpen),callback:function ($$v) {_vm.isOpen=$$v;},expression:"isOpen"}},[_c('v-layout',{attrs:{"column":"","fill-height":""}},[_c('v-toolbar',{attrs:{"color":"primary","dark":"","flat":""}},[_c('v-list',{staticClass:"pa-1"},[_c('v-list-tile',{attrs:{"avatar":""}},[_c('v-list-tile-avatar',[_c('v-icon',[_vm._v("event")])],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-list-tile-title',[_vm._v(_vm._s(_vm.$vuetify.t('$vuetify.dateRangeShortcuts.drawerTitle')))])],1),_vm._v(" "),_c('v-list-tile-action',[_c('v-btn',{attrs:{"flat":"","fab":"","small":""},on:{"click":_vm.toggleOptionsDrawer}},[_c('v-icon',[_vm._v("chevron_left")])],1)],1)],1)],1)],1),_vm._v(" "),_c('v-flex',{attrs:{"xs10":"","sm6":"","md4":""}},[_c('v-list',{staticClass:"pa-1"},_vm._l((_vm.pickerOptions),function(option,index){return _c('v-list-group',{key:index,attrs:{"prepend-icon":option.icon,"no-action":""},model:{value:(option.active),callback:function ($$v) {_vm.$set(option, "active", $$v);},expression:"option.active"}},[_c('v-list-tile',{attrs:{"slot":"activator"},slot:"activator"},[_c('v-list-tile-title',[_vm._v(_vm._s(_vm.$vuetify.t(option.title)))])],1),_vm._v(" "),_c('v-list-tile-content',[_c('v-layout',{attrs:{"align-center":"","justify-start":"","column":"","fill-height":""}},[(option.type === 'group')?[_c('v-btn-toggle',{staticStyle:{"flex-direction":"column","width":"100%"},model:{value:(_vm.btnGroup),callback:function ($$v) {_vm.btnGroup=$$v;},expression:"btnGroup"}},[_vm._l((option.options),function(compo,index){return [((_vm.allowBackInTime || _vm.evaluate(compo.if)))?_c('v-layout',{key:index,staticClass:"mx-3 py-1",attrs:{"row":"","fill-height":""}},[_c(compo.type,{tag:"component",staticStyle:{"width":"100%"},attrs:{"block":"","dense":true,"flat":"","hide-details":true,"hint":compo.hint,"loading":compo.loading,"single-line":true},on:{"change":function($event){_vm.onAction(
                                                            ...
                                                            compo.if
                                                        );}}},[(compo.icon)?_c('v-icon',[_vm._v(_vm._s(compo.icon))]):_vm._e(),_vm._v(" "),_c('template',{slot:"default"},[_vm._v("\n                                                    "+_vm._s(_vm.$vuetify.t(compo.title))+"\n                                                ")])],2)],1):_vm._e()]})],2)]:[_vm._l((option.options),function(compo,index){return [((_vm.allowBackInTime || _vm.evaluate(compo.if)))?_c('v-layout',{key:index,staticClass:"mx-3 py-1",attrs:{"row":"","fill-height":""}},[_c(compo.type,{tag:"component",staticStyle:{"width":"100%"},attrs:{"block":"","clearable":_vm.multiRange || compo.multiple,"deletable-chips":true,"dense":true,"flat":"","hide-details":true,"hint":_vm.$vuetify.t(compo.label),"items":_vm.buildSelectionList(compo.items),"item-text":_vm.getItemText,"item-value":_vm.getItemValue,"label":_vm.$vuetify.t(compo.label),"loading":compo.loading,"multiple":compo.multiple,"no-data-text":_vm.$vuetify.t(compo.label),"prepend-icon":compo.icon,"single-line":true,"small-chips":true,"value":compo.isOpen,"compo":compo},on:{"change":function($event){_vm.onAction(
                                                        _vm.pickerConfig.pickerDate,
                                                        $event, 
                                                        compo.action, 
                                                    ...
                                                    var item = ref.item;
                                                    var index = ref.index;
return [(item.text.length > 5)?[(compo.value.length === 1)?[(index === 0)?_c('v-chip',{attrs:{"small":""}},[_c('span',[_vm._v(_vm._s(item.text))])]):_vm._e()]:[(index === 0)?_c('span',{staticClass:"grey--text"},[_vm._v("\n                                                            "+_vm._s(compo.value.length)+" selected\n                                                        ")]):_vm._e()]]:[(compo.value.length <= 3)?[_c('v-chip',{attrs:{"small":""}},[_c('span',[_vm._v(_vm._s(item.text))])])]:[(index <= 1)?_c('v-chip',{attrs:{"small":""}},[_c('span',[_vm._v(_vm._s(item.text))])]):_vm._e(),_vm._v(" "),(index === 2)?_c('span',{staticClass:"grey--text caption"},[_vm._v("(+"+_vm._s(compo.value.length - 2)+" others)")]):_vm._e()]]]}}]),model:{value:(compo.value),callback:function ($$v) {_vm.$set(compo, "value", $$v);},expression:"compo.value"}},[_vm._v(" "),_c('template',{slot:"default"},[_vm._v("\n                                                "+_vm._s(compo.title)+"\n                                            ")])],2)],1):_vm._e()]})]],2)],1)],1)}),1)],1)],1)],1)};
var __vue_staticRenderFns__ = [];
  ...
  var DateRangeShortcutDrawer = __vue_normalize__(
...
module.exports = DateRangeShortcutDrawer;
