 ...
 */
/* private */ function momentCurrentQuarter (date = null, format = '') {
...
export default {
  methods: {
    ...
    getPeriodDates (date = null, periodNumber = 1) {
      ...
      return momentGetPeriodDates(date, periodNumber)
    },
    ...
    getCurrentDate (date = null) {
      let _mit = moment(date || undefined)
      return _mit.date()
    },
    ...
    getCurrentWeek (date = null, format = '') {
      let _mit = moment(date || undefined, format)
      return _mit.week()
    },
